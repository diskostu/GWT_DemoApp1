 ...
 */
public class DemoApp1Test extends GWTTestCase {

    /**
     * Must refer to a valid module that sources this class.
     */
    public String getModuleName() {
        return "de.diskostu.demo.DemoApp1JUnit";
    }
    ...
    public void testGreetingService() {
        ...
        target.setServiceEntryPoint(GWT.getModuleBaseURL() + "demoapp1/greet");
